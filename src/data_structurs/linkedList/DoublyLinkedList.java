...
public class DoublyLinkedList {
    ...
    /**
     * Insert an element at the certain index
     *
     * @param value
     * @param index
     */
    public void insertAtCertainIndex(int value, int index){
        Link temp = head;
        int count = 0;
    ...
    /*
     * Removes the first element in the given list and updates head element
     *
     */
    ...
    /**
     * Removes the certain element in the given list
     *
     * @param index
     */
    public void removeElementAtCertainIndex(int index){
        Link temp = head;
        int count = 0;
        while(temp!=null && ++count!=index)
            temp = temp.next;
